...
SYSTEM_PROMPT = (
    ...
    "DO NOT book an appointment and DO NOT call run_care_workflow. Immediately advise them to 'Call 911 or visit the Emergency Room immediately'.\n"
    "4. If they need an appointment and it is not an emergency, use the search_doctors tool to find available "
